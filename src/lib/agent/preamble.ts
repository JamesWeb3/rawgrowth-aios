  ...
  if (canCommand) {
    preamble +=
      ...
      [
        ...
        "      • Instagram reels -> actor_id \"apify/instagram-reel-scraper\", run_input { \"username\": [\"<handle1>\", \"<handle2>\"], \"resultsLimit\": 30 }  (the reel scraper takes BARE HANDLES under `username`, NOT URLs under `directUrls` - live-verified 2026-05-15)",
